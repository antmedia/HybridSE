<?php
	function check_coupons($marca){
		...
		print_r('<td valign="top" align="right"><img src="http://localhost/hybrid_coupons/jZebra/misc/10desconto.png" width="50px"></td>');
		print_r("</tr>");
		print_r("<tr>");
		...
		print_r('<td><img src="http://localhost/hybrid_coupons/jZebra/misc/danone_logo.png" width="100px">');
		print_r("</tr>");
	}
