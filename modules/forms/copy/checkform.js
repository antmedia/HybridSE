...
if (!window.jQuery) {
    ...
    (function() { 
        ...
        settings = jQuery.extend({
            ...
            document         : /[\w]+\.(doc|docx|txt|pdf)$/gi,
            pdf              : /[\w]+\.(pdf)$/gi,
            letters         : /[a-zA-Z áÁàÀâÂãÃéÉèÈêÊíÍìÌîÔóÓòÒôÔõÕúÚùÙûÛçÇ]+\ [a-zA-Z áÁàÀâÂãÃéÉèÈêÊíÍìÌîÔóÓòÒôÔõÕúÚùÙûÛçÇ]{0,}/,     
            enable           : false,
            err_class        : "invalidInput",
            err_list         : false,
            alias            : 'name',
            ...
            defval           : 'defval',
            callback         : '',
            err_message      : "Por favor preencha todos os campos obrigatórios assinalados a vermelho\n",
        ...
        function equal(obj) { 
            ...
            if (settings['err_list'])    
                err_list += '- "' + obj.attr(settings['alias']) + '" ' + err_msgs['equal'] + '\n';
            return false;
        }
