...
<script type="text/javascript">
    ...
    function drawVisualization() {
      var data = google.visualization.arrayToDataTable([
        ['Country', 'Popularity'],
		<?php foreach($fans_country as $key=>$value) { ?>
		['<?php echo $key; ?>', <?php echo $value; ?>],
		<?php } ?>
      ]);
    
      var geomap = new google.visualization.GeoMap(
          document.getElementById('fans_by_country'));
      geomap.draw(data, 
			...
			<table class="chart">
				<thead>
					<tr>
						<th></th>
						<?php 
							foreach($daily_fans as $key=>$value) {
...
<div class="grid_6">
	<div class="box">
		...
		<div class="header">
			<h2><img class="icon" src="img/icons/packs/fugue/16x16/chart-up-color.png">Fans por Países</h2>
		</div>
		
		<div class="content">
			<div id="fans_by_country"></div>
		</div>
	</div>
</div>
		...
		<div class="content" style="height: 250px;">
			<table class="chart" data-type="bars">
				...
				<tbody>
					<tr>
						<th>Masculino</th>
						<td><?php echo $fans_male['13-17']; ?></td>
						<td><?php echo $fans_male['18-24']; ?></td>
						<td><?php echo $fans_male['25-34']; ?></td>
						<td><?php echo $fans_male['35-44']; ?></td>
						<td><?php echo $fans_male['45-54']; ?></td>
						<td><?php echo $fans_male['55-64']; ?></td>
						<td><?php echo $fans_male['65+']; ?></td>
					</tr>
					<tr>
						<th>Feminino</th>
						<td><?php echo $fans_female['13-17']; ?></td>
						<td><?php echo $fans_female['18-24']; ?></td>
						<td><?php echo $fans_female['25-34']; ?></td>
						<td><?php echo $fans_female['35-44']; ?></td>
						<td><?php echo $fans_female['45-54']; ?></td>
						<td><?php echo $fans_female['55-64']; ?></td>
						<td><?php echo $fans_female['65+']; ?></td>
					</tr>
				</tbody>	
			</table>
		</div><!-- End of .content -->
			...
			<table class="chart" data-type="bars">
				<thead>
					<tr>
						<?php
							$count=0;
							foreach($fans_by_city as $key=>$value) { 
								if($count++==10) break;
								$city=explode(",",$key);
								echo "<th>$city[0]</th>";
							}
